...
class ManageStudentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rgGender.setOnCheckedChangeListener { radioGrup, i ->
    ...
    private fun onEditMode() {
        ...
        txtAddress.setText(i.getStringExtra("address"))
    ...
    private fun create() {
        ...
        AndroidNetworking.post(ApiEndPoint.CREATE)
            ...
            .addBodyParameter("address",txtAddress.text.toString())
    ...
    private fun delete(){
        ...
        AndroidNetworking.get(ApiEndPoint.DELETE+"?nim="+txtNim.text.toString())
            .setPriority(Priority.MEDIUM)
            .build()
            .getAsJSONObject(object : JSONObjectRequestListener {
